...
export default function StoryVisualPlayer({ audioUrl, timeline, title, artwork, knownDuration, autoPlay, onShare, onEnded }: Props) {
  ...
  const togglePlay = useCallback(() => {
    ...
    // Use audio.paused directly instead of React state to avoid stale closure issues
    if (!audio.paused) {
      audio.pause();
    } else {

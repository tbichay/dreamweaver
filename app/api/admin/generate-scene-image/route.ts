...
const LANDSCAPE_SCENES: Record<string, string> = {
  ...
  night_forest: "The KoalaTree at night. Deep blue-purple sky with stars and a glowing full moon. Soft silver moonlight illuminating the trunk. Mystical, peaceful atmosphere.",
